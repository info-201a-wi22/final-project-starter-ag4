...
page5 <- tabPanel(
  ...
  h3("Abstract: "),
  p("Our main question is how societal changes influence the popularity of music 
    ...
    is not enough extensive and reliable data available; To address this concern we will find as much data as 
    possible and compare to ensure accuracy. Considering that music is more accessible than ever, this 
    is important because music is integral to the lives of many people. Accordingly, we plan to observe trends 
